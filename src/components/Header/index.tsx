      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 sm:px-8 xl:mr-12">
              <Link
                href="/"
                        ...
                        {menuItem.path ? (
                          ...
                          <>
                            <p
                              ...
                              className={`text-dark group-hover:text-primary flex cursor-pointer items-center justify-between py-2 text-base sm:text-lg font-semibold lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 dark:text-white/70 dark:group-hover:text-white ${gabriela.className}`}
                            >
                              {menuItem.title}
                              <span className="pl-3">
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  key={index}
                                  className={`text-dark hover:text-primary block rounded-sm py-2.5 text-base font-medium lg:px-3 dark:text-white/70 dark:hover:text-white ${gabriela.className}`}
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
